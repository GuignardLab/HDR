\chapter{From coding algorithms to decoding development}
\chaptertoc{}
\paragraph{}Deeply rooted in \emph{theoretical computer science}, I have transitioned to being also a \emph{biologist}.
...
\paragraph{}After my training in theoretical computer science I sought to develop new computationial frameworks and methods to better our understanding of embroynic development.
First, during my Ph.D, I worked at understanding how cell-cell communication impact the highly stereotyped development of ascidians embryos.
This research led to the modelling of cell-cell signalling in the ascidian \emph{Phallusia mammillata} (\emph{P.m.}).
...
I have successfully studied and developed quantitative tools for a wide range of model and non-model organisms, including ascidians~\cite{Guignard2020}, Drosophila~\cite{Malin-Mayor:2022aa}, mouse~\cite{McDole:2018aa,Sampath-Kuma:2022aa}, Parhyale~\cite{Wolff:2018aa}, zebrafish, gastruloid~\cite{Gros2025} and Trunk-Like-Structure (organoids)~\cite{Veenvliet:2020aa}.
...
My work have been proven useful to the scientific community and it shows through the citation number (1201 in the past 5 years\footnote{according to \href{https://scholar.google.fr/citations?user=PCSQdWIAAAAJ&hl=en}{Google Scholar}}) and the number of times my software have been downloaded (for example more than 10 thousand times\footnote{according to \href{https://pepy.tech/projects/napari-sc3d-viewer}{pepy.tech}})
\paragraph{}In this chapter I present my past research projects for which I was contributor and that led to publications in peer-reviewed journals:
\begin{itemize}
...
\item[] \textbf{Project 4}: A quantitative pipeline for whole-mount deep imaging and analysis of multi-layered organoids across scales
...
Moreover, the core software that I developed for this project has been installed about 10 thousand times according to \href{https://pepy.tech/projects/napari-sc3d-viewer}{pepy.tech}.

\section{A quantitative pipeline for whole-mount deep imaging and analysis of multi-layered organoids across scales}
\begin{figure}[h]
\begin{center}
\includegraphics[width=.7\textwidth]{../Figures/gastruloids}
\caption{\textbf{Graphical abstract of~\cite{Gros2025}}.
...
\paragraph{}For my first project as a group leader at the Laboratoire d'Informatique et Syst\`emes then at the Institut de Biologie du D\'eveloppement de Marseille I worked in collaboration Sham Tlili and Pierre-François Lenne in the group of Pierre-François Lenne.
For this project, we were intetested in enabling the quantification of the development of gastruloid across spatial scales, from the sample scale to the single cell scale.
We supervised Alice Gros, a Ph.D student who developed an integrated imaging and analysis pipeline to achieve in toto, multiscale 3D imaging and quantification of dozens of gastruloids, ranging from 100 to 500 µm in diameter.
Using this pipeline, we performed dual-view two-photon imaging, spectral unmixing, and advanced computational processing to reconstruct and segment individual cell nuclei and mitotic events with high accuracy.
These segmentations enabled the first quantitative, single-cell resolution analysis of gastruloid development, examining spatial patterns of gene expression, nuclear morphology, cell density, and proliferation across multiple spatial scales.

\paragraph{}Remarkably, the pipeline revealed that gastruloid development is characterized by a tissue-scale organization, with distinct anterior and posterior domains separated by a sharp boundary, and that local cell deformations are spatially correlated with gene expression patterns.
This quantification demonstrated, for the first time, that gastruloid morphogenesis is driven by both mechanical stresses and gene expression gradients, with nuclear shapes serving as proxies for cell-scale mechanotransduction and tissue-level organization.

\paragraph{}Moreover, the analysis of gene expression gradients (T-Bra, Oct4, FoxA2) and nuclear morphology across gastruloids of different sizes and developmental stages showed that developmental variability is constrained by both intrinsic cellular properties and tissue-scale interactions.
The similarity in spatial patterns observed across gastruloids, despite variations in size and initial cell number, suggests that gastruloid morphogenesis is governed by robust, self-organizing principles rather than stochastic fluctuations.

\paragraph{}The 3D reconstructions of dozens of gastruloids, combined with multiscale spatial correlation analysis, revealed that cell-cell communication and tissue patterning in gastruloids are regulated by a combination of local cell deformations and gene expression gradients.
This mechanism differs from classical morphogen diffusion models, as it relies on the integration of mechanical and biochemical signals at both the cellular and tissue scales. While such mechanochemical coupling has been previously observed, this study provides the first quantitative, in toto characterization of its role in 3D organoid development.

\paragraph{}We also demonstrated, both computationally and experimentally, that perturbations in local cell geometry—such as changes in nuclear deformation or cell density—can significantly alter cell fate and tissue organization.
This observation implies that gastruloid cells are under tight geometric constraints, where the maintenance of correct tissue architecture is critical for proper development.
The reliance on cell geometry rather than absolute protein concentration levels for patterning suggests that the constraints on genetic regulation may be relaxed, potentially facilitating rapid evolutionary adaptation while preserving tissue morphology.

\paragraph{}This research led to the development of the open-source Python package \textbf{Tapenade} and a suite of napari plugins, providing the community with user-friendly tools for multiscale bioimage analysis.
The pipeline’s versatility and robustness make it applicable to a wide range of dense 3D tissues, including tumoroids and embryos, offering a powerful framework for quantitative developmental biology and biomedical research.

\paragraph{}The study was published in eLife~\cite{Gros2025}. The open-source tools and datasets are publicly available, enabling further exploration and adaptation by the scientific community. This work also contributed to multiple conference presentations and collaborations, reinforcing its impact on the fields of organoid biology, bioimage analysis, and developmental mechanics.
...
Then by teaching ``Implementing Turing Patterns using design patterns in Python'' and by heading the course ``Introduction to Python'' for Master 2 \emph{CMB} students.
...
\paragraph{}Finally, for the last 4 years I have been promoting computer science applied to biology by co-organising a Hackathon to bring computer scientists and engineers to work on biological problems.
...
% They are ordered by number of downloads (according to \href{https://pepy.tech/projects/napari-sc3d-viewer?timeRange=threeMonths&category=version&includeCIDownloads=true&granularity=daily&viewType=line&versions=2.0.0%2C1.1.1%2C1.1.0}{pepy.tech}) or otherwise alphabetically.
